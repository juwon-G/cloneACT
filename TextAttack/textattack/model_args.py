...
ClassTrModelNames = ["marian-en-fr-sst2",
                     "marian-en-fr-sst2-2class",
                     "marian-en-fr-ag",
                     "marian-en-fr-mr",
                     "marian-en-de-sst2",
                     "marian-en-de-ag",
...
ClassTrModelNames2 = ["mbart-en-fr-sst2",
                     "mbart-en-fr-sst2-2class",
                     "mbart-en-fr-ag",
                     "mbart-en-fr-mr",
                     "mbart-en-de-sst2",
                     "mbart-en-de-ag",
...
TEXTATTACK_MODELS = {
    ...
    #
    # marian for translation
    #
    "marian-en-de": "english_to_german",
    "marian-en-fr": "english_to_french",
    #
    # marian for translation-classification
    #
    "marian-en-fr-sst2":"english_to_french",
    "marian-en-fr-sst2-2class":"english_to_french",
    "marian-en-fr-ag":"english_to_french",
    "marian-en-fr-mr":"english_to_french",
    "marian-en-de-sst2":"english_to_german",
    "marian-en-de-ag":"english_to_german",
    "marian-en-de-mr":"english_to_german",
    #
    # mbart for translation-classification
    #
    "mbart-en-fr-sst2":"english_to_french",
    "mbart-en-fr-sst2-2class":"english_to_french",
    "mbart-en-fr-ag":"english_to_french",
    "mbart-en-fr-mr":"english_to_french",
    "mbart-en-de-sst2":"english_to_german",
    "mbart-en-de-ag":"english_to_german",
    "mbart-en-de-mr":"english_to_german",
    #
...
class ModelArgs:
    ...
    def _create_model_from_args(cls, args):
        ...
        if args.model_from_file:
            ...
            elif args.model=="marian-en-de" or args.model=="marian-en-fr" :
                model = textattack.models.helpers.MarianForTextToText.from_pretrained(
                    args.model
                )
            elif any(xx==args.model for xx in ClassTrModelNames):
                model = textattack.models.helpers.MarianClassTr.from_pretrained(
                    args.model
                )
            elif any(xx==args.model for xx in ClassTrModelNames2):
                model = textattack.models.helpers.MbartClassTr.from_pretrained(
                    args.model
                )
            else:
            ...
            # a HuggingFace model).
            if isinstance(model, (textattack.models.helpers.T5ForTextToText,textattack.models.helpers.MarianForTextToText,textattack.models.helpers.MarianClassTr,textattack.models.helpers.MbartClassTr)):
