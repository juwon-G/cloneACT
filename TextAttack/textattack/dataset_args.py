...
TEXTATTACK_DATASET_BY_MODEL = {
    ...
    "marian-en-de": (
        "textattack.datasets.helpers.WMTTranslationDataset",
        "en",
        "de",
    ),
    "marian-en-fr": (
    ...
    "marian-en-fr-sst2": (
        "textattack.datasets.helpers.ClassTranslationDataset",
        "en", "fr", "sst2", "marian",
    ...
    "marian-en-fr-ag": (
        "textattack.datasets.helpers.ClassTranslationDataset",
        "en", "fr", "ag_news", "marian",
    ),
    "marian-en-fr-mr": (
        "textattack.datasets.helpers.ClassTranslationDataset",
        "en", "fr", "rotten_tomatoes", "marian",
    ),
    "marian-en-de-sst2": (
        "textattack.datasets.helpers.ClassTranslationDataset",
        "en", "de", "sst2", "marian",
    ...
    "marian-en-de-ag": (
        "textattack.datasets.helpers.ClassTranslationDataset",
        "en", "de", "ag_news", "marian",
    ),
    "marian-en-de-mr": (
        "textattack.datasets.helpers.ClassTranslationDataset",
        "en", "de", "rotten_tomatoes", "marian",
    ),
