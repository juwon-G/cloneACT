...
from textattack.goal_functions import UntargetedClassTrS
...
class ClassTranslationTextFoolerS(AttackRecipe):
    """
    ...
    def build(model_wrapper, goal_function="UntargetedClassTr",alpha=0.5,thr=0.3,ground_max_score=None,max_min_score=None,dif_score=None,num_class=1,cw=False):
        ...
        #
        goal_function = UntargetedClassTrS(model_wrapper,alpha=alpha,thr=thr,ground_max_score=ground_max_score,max_min_score=max_min_score,dif_score=dif_score,num_class=num_class,cw=cw)
        #
